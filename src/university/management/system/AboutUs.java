...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - Asansol Engineering College");
            ...
            JLabel l6 = new JLabel("Developed By : Anirban Chattaraj");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Number: +9196296147849");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact : anirbanchattaraj9@gmail.com");
            ...
            JLabel l10 = new JLabel("Phone - +916296147849");
